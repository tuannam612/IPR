...
title_label = customtkinter.CTkLabel(app, text="Choose the options below", font=("Helvetica", 14, "bold"))
title_label.pack(ipadx=5, ipady=5)

height_var = tkinter.StringVar()
height_entry = customtkinter.CTkEntry(app, width=200, height=20, border_color="black", textvariable=height_var, placeholder_text="Enter the height:")
height_entry.pack(padx=5, pady=5)

width_var = tkinter.StringVar()
width_entry = customtkinter.CTkEntry(app, width=200, height=20, border_color="black", textvariable=width_var, placeholder_text="Enter the width:")
...
resize_button.place(relx=0.5, rely=0.3, anchor=customtkinter.CENTER)
